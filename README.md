...
Download the demo app from this link - <a href="https://github.com/hummatli/AppCrossPromoter/releases/download/v2.1.5/DemoApp.-.AppCrossPromoter.apk">DemoApp</a>. You can easly test the lib's functionality.
