...
<a href="https://github.com/hummatli/AppCrossPromoter/releases/download/v2.1.5/DemoApp.-.AppCrossPromoter.apk">The AppCrossPromoter - DemoApp</a> app has published on the Google PlayStore. You can easly test the lib's functionality by downloading it.
